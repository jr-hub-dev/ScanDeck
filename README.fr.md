...
| Pied de fenêtre | **Ouvrir le classeur**, **Options**, version (`v1.0.2`). S’il existe une Release GitHub plus récente, **MAJ v…** s’affiche — un clic ouvre la page de téléchargement. |
