...
- **Partage** — envoi EDDN en direct (activé par défaut ; décoche si EDDI/EDMC envoie déjà EDDN). Clé API Inara optionnelle ; envoi avec le bouton **INARA**
...
| Zone | Contenu |
|---|---|
| Liste gauche | Corps du système en cours ; file carto sous le nom du système |
| Panneau droit | Planète sélectionnée : file bio, verdict, genres, espèces, progression des scans |
...
| Pied de fenêtre | **Ouvrir le classeur**, **Options**, **AIDE**, **LOGS EDDN**, **INARA**, version (`v1.3.0`). S’il existe une Release GitHub plus récente, **MAJ v…** s’affiche — un clic ouvre la page de téléchargement. |
